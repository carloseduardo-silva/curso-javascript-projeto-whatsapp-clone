   ...
   set id(value){
    ...
    getViewEl(me = true){
                        ...
                        <div class="_3DZ69" role="button">
                            ...
                            <div class="_3a5-b">
                                <div class="_1DZAH" role="button">
                                    <span class="message-time">${Format.timeStampToTime(this.timeStamp)}
                                    </span>
        ...
        if(me) {
            ...
            div.querySelector(".message-time").parentElement.appendChild(this.getStatusViewEl());
    ...
    // retorna elementHtml do status da mensagem.
    getStatusViewEl(){
